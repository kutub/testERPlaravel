    ...
    <section>
        <div class="card m-t-15">
            <header class="card-header" style="background-color:#00d1b2">
                <h1 style="color:#fff; font-size:20px" class="card-header-title has-text-centered">Create New Item</h1>
            </header>
                ...
                <b-steps
                    ...
                    <b-step-item label="Item Info" :clickable="isStepsClickable">
                        ...
                        <div class="card m-t-20">
                                        ...
                                        <div class="field is-horizontal">
                                            <div class="field-body">
                                                ...
                                                <b-field label="Item name"
                                                    type="is-danger"
                                                    :message="error">
                                                    <b-input type="text" v-model="fields.name" placeholder="Item name">
                                                    </b-input>
                                                </b-field>
                            ...
                            <footer class="card-footer p-t-15 p-b-15 p-l-15 has-text-right">
                                <a  @click="checkUniqe(fields, 'item')" class="button is-primary">Save</a>
                            </footer>
                        </div>
                    ...
                    <b-step-item label="Variation" :clickable="isStepsClickable" :type="{'is-success': isProfileSuccess}">
                        <div class="card m-t-20">
                            ...
                            <footer class="card-footer">
                                <a @click="checkUniqe(fields, 'variation')" class=" button is-primary">Save</a>
                            </footer>
                        </div>
                    </b-step-item>
                    ...
                    <b-step-item  label="Pricing" :clickable="isStepsClickable">
                        <div class="card m-t-20">
                                ...
                                <template>
                                    <section>
                                        <div class="field is-horizontal">
                                            ...
                                            <div class="field-body">
                                                 <b-field label="Cost Price (Without Tax)">
                                                    <b-input type="text" v-model="fields.cost_price" required></b-input>
                                                </b-field>
                            ...
                            <footer class="card-footer">
                                <a @click="checkUniqe(fields, 'pricing')"  class="button is-primary">Save</a>
                            </footer>
                        </div>
                    </b-step-item>
                    ...
                    <b-step-item  label="Inventory" :clickable="isStepsClickable">
                        <div class="card m-t-20">
                            ...
                            <div class="card-content">
                                <template>
                                    <section>
                                        ...
                                        <b-field horizontal label="Current Quantity:">
                                            <b-input placeholder="Quantity"
                                                type="text" v-model="fields.quantity">
                                            </b-input>
                                        </b-field>

                                        <b-field  horizontal label="Inventory To Add/Subtract:">
                                            <b-input placeholder="Inventory To Add/Subtract:"
                                            type="text"
                                            v-model="fields.inventory_add_subs"
                                            >
                                            </b-input>
                                        </b-field>
                            ...
                            <footer class="card-footer">
                                <a @click="checkUniqe(fields, 'inventory')"  class="card-footer-item">Save</a>
                            </footer>
                        </div>
                    </b-step-item>
                    ...
                    <b-step-item  label="Images" :clickable="isStepsClickable">
                        <div class="card m-t-20">
                            ...
                            <footer class="card-footer">
                                <a @click="checkUniqe(fields, 'image')" class="card-footer-item">Save</a>
                    ...
                    <b-step-item label="Locations" :clickable="isStepsClickable" disabled>
                        <div class="card m-t-20">
                            ...
                            <footer class="card-footer">
                                <a @click="checkUniqe(fields, 'location')" class="card-footer-item">Save</a>
                            </footer>
                        </div>
                    </b-step-item>
...
<script>
    ...
    export default {
        ...
        created(){
            axios.get('/home/items/categories')
                .then((response) => {
                    this.categories = response.data;
                }).catch((error) => {
                    console.log(error);
                });
            axios.get('/home/items/suppliers')
                .then((response) => {
        ...
        methods: {
                ...
                if(this.edited == false && model == 'item'){
                    ...
                    params: {
                        ...
                        if(response.data == false){
                            ...
                            axios({
                                method: 'post',
                                url:'http://devmarketer.com/home/items',
                                data: data,
                                params: {
                                    model: model
                                }
            ...
            onGetAttibute(){
                axios.get('/home/items/attributes')
                .then((response) => {
            ...
            onAddAttribute(id){
                ...
                axios.get('/home/items/attribute/'+id)
                .then((response) => {
